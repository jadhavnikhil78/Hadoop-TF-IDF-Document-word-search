//801021051 SURAJ M SHETTY - Task 1 (WordCount program to output the wordcount for each distinct word in each file)
...
public class DocWordCount extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        Job job = Job.getInstance(getConf(), " docwordcount "); // First Job to be created in hadoop
    ...
    public static class Reduce extends
            Reducer<Text, IntWritable, Text, IntWritable> {// Intwritable because Word Count comes in integers
